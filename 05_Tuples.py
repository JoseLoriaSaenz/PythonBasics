...
my_tuple = tuple()
print("my_tuple = tuple()", "my_tuple:", my_tuple, "Type:", type(my_tuple), "len:", len(my_tuple))

my_new_tuple = 1, True, "Hello"
print("my_new_tuple = 1, True, \"Hello\"", "my_new_tuple:", my_new_tuple, "Type:", type(my_new_tuple), "len:", len(my_new_tuple))
...
print("my_new_tuple[2] = False -->", '\033[91m', '\033[1m', "Tuples are inmutable. This Will Throw An Exception".upper(), '\033[0m')
...
a, b, c = my_new_tuple
print("a, b, c = my_new_tuple -->", "tuple:", my_new_tuple, "Destructured", "a =", a, "b =", b, "c =", c)

a, b = my_new_tuple[0:2]
print("a, b = my_new_tuple[0:2] -->", "tuple[0:2]:", my_new_tuple[0:2], "Destructured", "a =", a, "b =", b)
