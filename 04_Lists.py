...
my_list = list()
print("my_list = list(), type, len -->", my_list,
      type(my_list),  "len:", len(my_list))

my_list_2 = []
print("my_list = [], type, len -->", my_list_2,
      type(my_list),  "len:", len(my_list_2))

my_int_list = [1, 2, 3]
print("my_int_list = [1,2,3], len -->", my_int_list, "len:", my_int_list)

my_multitype_list = [1, True, "Hello"]
print("my_int_list = [1,True,\"Hello\"], len -->",
      my_multitype_list,  "len:", len(my_multitype_list))
...
print("(my_list + my_org_list).count(1980) -->",
      (my_list + my_org_list).count(1980))
...
print("a, b, c = my_multitype_list -->", "list:", my_multitype_list,
...
print("POP popped_value = my_list_as_stack.pop() -->",
      "Poped Value:", poped_last_value, "Stack:", my_list_as_stack)

poped_value_by_index = my_list_as_stack.pop(1)
print("POP poped_value_by_index = my_list_as_stack.pop(1) -->",
      "Poped Value by Index:", poped_value_by_index, "Stack:", my_list_as_stack)
...
print(
    "even_square_vector = [x**2 for x in linear_vector if x % 2 != 0 ] -->", even_square_vector)

print("[str(round(pi, i)) for i in range(1, 6)] -->",
      [str(round(pi, i)) for i in range(2, 10)])
