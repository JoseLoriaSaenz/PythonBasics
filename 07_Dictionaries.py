...
my_dict = dict()
print("my_dict = dict() -->", my_dict, "Type:",
      type(my_dict), "len:", len(my_dict))

my_other_dict = {}
print("my_other_dict = {{}} -->", my_other_dict, "Type:",
      type(my_other_dict), "len:", len(my_other_dict))
...
print("my_dict[\"address\"] = \"Heredia\" -->", my_dict,
      "Type:", type(my_dict), "len:", len(my_dict))

my_dict["languages"] = {"Lang_1": "C#",
                        "Lang_2": "Javascript", "Lang_3": "Visual Basic"}

print("dict(john=4139, guido=4127, jack=4098) -->",
      dict(john=4139, guido=4127, jack=4098))
...
print("my_dict[\"languages\"][\"Lang_2\"] = \"Kotlin\" -->",
      my_dict["languages"]["Lang_2"])
...
print("\"Kotlin\" in my_dict[\"languages\"] -->",
      "Kotlin" in my_dict["languages"])
